...
public class NaturalNumberDecomposition{
    ...
    public void main(int n){
        for(ArrayList<Integer> decomp: decompose(n)) System.out.println(decomp);
    	
    	
//    	HashMap<Integer, HashSet<Decomposition> > allDecomposes=new  HashMap<Integer, HashSet<Decomposition> >();
