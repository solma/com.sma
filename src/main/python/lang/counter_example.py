...
def demo():
  ...
  my_print("After removing zero counts", remove_zero_cnt(ctr))
  ctr.update([1, 2])
  my_print("After addition", ctr)
  my_print("Converted to frequency", convert_to_percentage(ctr))
