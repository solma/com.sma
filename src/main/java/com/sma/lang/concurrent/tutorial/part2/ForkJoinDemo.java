...
public class ForkJoinDemo {
  ...
  public static void main(String[] args) {
    ...
    System.out
        .printf("sequential sort completed in %d millis%n", System.currentTimeMillis() - startTime);
    for (int i = 0; i < array.length; i++)
    ...
    System.out
        .printf("parallel sort completed in %d millis%n", System.currentTimeMillis() - startTime);
