...
public class MergeTwoSortedList {
	...
	public void main(){
		System.out.println(mergeTwoLists(ListNode.buildList(new int[]{2,6,7,9}), ListNode.buildList(new int[] {1,3,8})));
	}
    ...
    public ListNode mergeTwoListsFirstPass(ListNode l1, ListNode l2) {
        ...
        if (l2==null&&l1!=null) {
            if (l2Prev!=null) l2Prev.next=l1; //copy rest of l1 to l2
            else head=l1;
        }
        return head;
    }
