...
public class ReflectionUtil {
  ...
  public static void main(String[] args) {
    Type superclassType = HashMap.class.getGenericSuperclass();
    Type[] typeParams = ((ParameterizedType) superclassType).getActualTypeArguments();

    System.out.println(Arrays.toString(getParameterizedTypes(typeParams)));
  }

  /**
   * {@link Type#toString()} value is the fully qualified class name prefixed
   * with {@link ReflectionUtil#TYPE_INTERFACE_NAME_PREFIX}. This method will substring it, for it to be eligible
