...
public class NQueens {
    ...
    public ArrayList<String[]> solveNQueens(int n) {
        return solveNQueens(n, new ArrayList<Integer>(), new ArrayList<Integer>(),new ArrayList<Integer>());
    }
    ...
    public ArrayList<String[]> solveNQueens(int n, ArrayList<Integer> cols, ArrayList<Integer> diags, ArrayList<Integer> counterDiags)
    {
        ...
        for (int col=0;col<n;col++) {
            if (cols.contains(col)||diags.contains(col-cols.size())||counterDiags.contains(col+cols.size())) continue;
            cols.add(col);
