...
public class MinDepthLeafBinaryTree {
    ...
    public void minDepth(TreeNode n, int[] minDepth, int curDepth){
        if(n.left==null&&n.right==null&&curDepth<minDepth[0]) minDepth[0]=curDepth;
        if(n.left!=null) minDepth(n.left, minDepth, curDepth+1);
        if(n.right!=null) minDepth(n.right, minDepth, curDepth+1);        
    }
}